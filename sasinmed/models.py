...
class Visit(db.Model):
    ...
    def __repr__(self):
        return f'Wizyta dnia {self.date_of_visit}'
...
class Diagnosis(db.Model):
    ...
    # foreign keys:
    visit_id = db.Column(db.Integer, ForeignKey('visit.id'), nullable=False)

    # connections:
    visit = relationship("Visit", back_populates="diagnosis", uselist=False)
